...
3. Once logged into **Windows Admin Center WAC**, if you receive a notification that **extension catalogs are being updated** then wait for the message that the extensions were successfully updated and click **OK** and wait for WAC to relaunch; then, under **All connections**, Click **Add**.
